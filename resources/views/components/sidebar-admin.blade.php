<aside class="sidenav navbar navbar-vertical navbar-expand-xs border-0 border-radius-xl my-3 fixed-start ms-3 "
    ...
    <div class="sidenav-header">
        ...
        <a class="navbar-brand m-0 d-flex justify-content-center"
            ...
            <img src="{{ asset('image/havenbook.png') }}" class="" alt="main_logo">
            {{-- <span class="ms-1 font-weight-bold">the Haven Book</span> --}}
        </a>
    </div>
    ...
    <div class="collapse navbar-collapse  w-auto " id="sidenav-collapse-main">
        <ul class="navbar-nav">
            @role('admin')
                ...
                <li class="nav-item">
                    <a class="nav-link" href="{{ route('manage-book') }}">
                        <div
                            class="icon icon-shape icon-sm shadow border-radius-md bg-white text-center me-2 d-flex align-items-center justify-content-center">
                ...
                <li class="nav-item mt-3">
                    <h6 class="ps-4 ms-2 text-uppercase text-xs font-weight-bolder opacity-6">Payment pages</h6>
                </li>
                <li class="nav-item">
                    <a class="nav-link  " href="{{ route('manage-payment') }}">
                        <div
                            class="icon icon-shape icon-sm shadow border-radius-md bg-white text-center me-2 d-flex align-items-center justify-content-center">
                        ...
                        <span class="nav-link-text ms-1">Manage Transaction</span>
                    </a>
                </li>
                <li class="nav-item">
    ...
    <div class="sidenav-footer mx-3 ">
        <div class="card card-background shadow-none card-background-mask-secondary" id="sidenavCard">
            <div class="full-background"
                style="background-image: url('{{ asset('soft-ui-dashboard-main/img/curved-images/white-curved.jpg') }}')">
            </div>
