                                ...
                                <div class="card-body">
                                    ...
                                    <div class="input-group input-group-sm mb-3">
                                        ...
                                        <input type="number"
                                            ...
                                            aria-describedby="basic-addon1" min="1" value="1" id="lamaSewa"
                                            name="number_of_month" required>
                                    ...
                                    <div class="input-group input-group-sm mb-3">
                                        <select
                                            ...
                                            @foreach ($userAccounts->skip(1) as $account)
                                                <option value="{{ $account->id }}">{{ $account->bank->codename }} -
                                ...
                                <div class="card-body">
                                    ...
                                    <div class="input-group input-group-sm mb-3">
                                        ...
                                        <input type="text" class="form-control" placeholder="price"
                                            aria-label="price" aria-describedby="basic-addon1" id="hargaTotal"
